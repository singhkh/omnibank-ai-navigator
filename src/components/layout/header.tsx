            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent className="text-muted-foreground space-y-2">
                  ...
                  <ol className="list-decimal pl-5 space-y-2">
                    <li><b>Expand the Modeling Sections</b><br/>For each option ("Customer-Facing" and "Internal-Assist"), click to expand the "Financial Impact Model" and "Implementation Risk Model" sections.
                    </li>
                     <li><b>Adjust the Granular Levers</b><br/>Use the detailed sliders within each section to reflect your strategic assumptions. Adjust specific factors like "New Revenue & Cross-Sell Lift" or "Regulatory & Compliance Fines." As you move the sliders, you will see the "Overall Score" for that section update in real-time.
                    </li>
